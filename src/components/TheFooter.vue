...
<template>
  <footer
    class="text-center bg-fpurple sm:text-left"
    ...
    <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-16 lg:px-8">
        ...
        <div class="space-y-8 xl:col-span-1">
          ...
          <div class="flex pl-5 space-x-6 md:pl-0">
            <a
              ...
              :key="item.name"
              :href="item.href"
              class="text-fgreen hover:text-fgreen-dark2"
            >
      ...
      <div class="pt-8 mt-12 border-t border-white">
        <p class="text-base text-white xl:text-center">
          &copy; 2022 Fitme, Daniel Martin. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
